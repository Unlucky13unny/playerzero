  ...
  return (
    ...
    <div style={{
      ...
      <Link to="/leaderboards" style={{
        ...
        border: currentPage === "leaderboard" ? '1px solid #DC2627' : '1px solid #000000',
        borderRadius: '12px',
        ...
        <div style={{
          ...
          <svg width="24" height="24" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
            ...
            <path 
              ...
              stroke={currentPage === "leaderboard" ? "#DC2627" : "#000000"}
        ...
        <span style={{
          ...
          color: currentPage === "leaderboard" ? "#DC2627" : "#000000",
