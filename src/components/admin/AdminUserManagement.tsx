...
export const AdminUserManagement = () => {
  ...
  const handleUpdatePaymentStatus = async (userId: string, isPaid: boolean) => {
    try {
      const { error } = await adminService.updateUserPaymentStatus(
        userId, 
        isPaid, 
        isPaid ? 'premium' : undefined
      )
                ...
                <div key={user.id} className="table-row">
                  ...
                  <div className="table-cell actions-col">
                    <div className="action-buttons">
                      {!user.is_paid_user ? (
                        <button
                          onClick={() => handleUpdatePaymentStatus(user.id, true)}
                        ...
                        <button
                          onClick={() => handleUpdatePaymentStatus(user.id, false)}
                          className="action-btn downgrade-btn"
